...
namespace Y3.Models.DB
{
    public class QueryString
    {
        ...
        // INSERT
        public string QUERY_INSERT_USER = "INSERT INTO user (name, birthday, phone_number, session, memo) VALUES ";
        ...
        public string QUERY_INSERT_SESSION = "INSERT INTO session (date, trainer_id, trainer_name, user_id, user_name, session_price_id, session_price_name, session_count, session_total_price) VALUES ";

        // UPDATE
        public string QUERY_UPDATE_USER_1 = "UPDATE user u JOIN(";
        public string QUERY_UPDATE_USER_2 = ") v ON u.id=v.id SET u.name=v.name, u.birthday=v.birthday, u.phone_number=v.phone_number, u.session=v.session, u.memo=v.memo;";
